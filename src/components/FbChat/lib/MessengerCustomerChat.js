      ...
      (_ret =
        ((_temp =
          ((_this = _possibleConstructorReturn(
            this,
            (_ref =
              MessengerCustomerChat.__proto__ ||
              Object.getPrototypeOf(MessengerCustomerChat)).call.apply(
              _ref,
              [this].concat(args)
            )
          )),
  ...
  _createClass(MessengerCustomerChat, [
    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps) {
        if (
          ...
          prevProps.greetingDialogDisplay !==
            this.props.greetingDialogDisplay ||
    ...
    },
    {
      ...
      value: function createMarkup() {
        ...
        var minimizedAttribute =
          minimized !== undefined ? 'minimized="' + minimized + '"' : "";
        var themeColorAttribute =
          themeColor !== undefined ? 'theme_color="' + themeColor + '"' : "";
        var loggedInGreetingAttribute =
          loggedInGreeting !== undefined
            ? 'logged_in_greeting="' + loggedInGreeting + '"'
            : "";
        var loggedOutGreetingAttribute =
          loggedOutGreeting !== undefined
            ? 'logged_out_greeting="' + loggedOutGreeting + '"'
            : "";
        var greetingDialogDisplayAttribute =
          greetingDialogDisplay !== undefined
            ? 'greeting_dialog_display="' + greetingDialogDisplay + '"'
            : "";
        var greetingDialogDelayAttribute =
