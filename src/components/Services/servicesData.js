...
export const data = [
  {
    ...
    svg: (
      <svg
        ...
        viewBox="0 0 448 512"
        className=" svg-inline--fa fa-laptop-code fa-w-14 fa-9x"
      >
        <defs>
          <clipPath id="clip-RgRGw2maQsjx">
            <path
              fill="currentColor"
        ...
        <rect
          fill="currentColor"
          clipPath="url(#clip-RgRGw2maQsjx)"
          mask="url(#mask-SQqs6KqH9Ze6)"
          x="0"
          y="0"
          width="100%"
          height="100%"
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 448 512"
        className="svg-inline--fa fa-cogs fa-w-14 fa-9x"
      >
        <defs>
          <clipPath id="clip-gsEu9CV9j54c">
            <path
              fill="currentColor"
              d="M400 32H48C21.5 32 0 53.5 0 80v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V80c0-26.5-21.5-48-48-48z"
            ></path>
        ...
        <rect
          fill="currentColor"
          clipPath="url(#clip-gsEu9CV9j54c)"
          mask="url(#mask-8IazCPg84Zcx)"
          x="0"
          y="0"
          width="100%"
          height="100%"
    ...
    description: `If you need custom business 
    software. a mobile app, or your SaaS solution 
    built, our developers have you covered. 
    We also offer Robotic Process Automation (RPA), 
...

  {
    ...
    svg: (
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 448 512"
        className=" svg-inline--fa fa-users-cog fa-w-14 fa-9x"
      >
        <defs>
          <clipPath id="clip-OrkhJubgr482">
            <path
              fill="currentColor"
              d="M400 32H48C21.5 32 0 53.5 0 80v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V80c0-26.5-21.5-48-48-48z"
            ></path>
        ...
        <rect
          fill="currentColor"
          clipPath="url(#clip-OrkhJubgr482)"
          mask="url(#mask-G77bRhuuN7Xc)"
          x="0"
          y="0"
          width="100%"
          height="100%"
  ...
  },
  {
    ...
    link: "integration-modernization",
    svg: (
      <svg
        aria-hidden="true"
        focusable="false"
        ...
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 448 512"
        className=" svg-inline--fa fa-cubes fa-w-14 fa-9x"
      >
        <defs>
          <clipPath id="clip-xRJwktYWVxLS">
            <path
              fill="currentColor"
              d="M400 32H48C21.5 32 0 53.5 0 80v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V80c0-26.5-21.5-48-48-48z"
            ></path>
        ...
        <rect
          fill="currentColor"
          clipPath="url(#clip-xRJwktYWVxLS)"
          mask="url(#mask-e47I3vivMfxf)"
          x="0"
          y="0"
          width="100%"
          height="100%"
...
//       xmlns="http://www.w3.org/2000/svg"
//       viewBox="0 0 448 512"
//       className=" svg-inline--fa fa-shopping-cart fa-w-14 fa-9x"
//     >
//       <defs>
//         <clipPath id="clip-nNZMjqh2q3Ej">
//           <path
//             fill="currentColor"
//             d="M400 32H48C21.5 32 0 53.5 0 80v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V80c0-26.5-21.5-48-48-48z"
//           ></path>
...
//       <rect
//         fill="currentColor"
//         clipPath="url(#clip-nNZMjqh2q3Ej)"
//         mask="url(#mask-HET27RH3ZJ27)"
//         x="0"
//         y="0"
//         width="100%"
//         height="100%"
...
//     </svg>
//   ),
//   description: `Looking to sell a few things
//   on your website?  Or maybe thousands of items?
//   We have the tools to get you up and running
//   with a secure, easy to use shopping cart
//   and sales management tool customized just
//   for you!`
// },
