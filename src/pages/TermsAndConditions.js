...
export default function TermsAndConditions() {
  return (
    <div className="privacy-policy" style={{ padding: "4rem" }}>
      <h1>Terms and Conditions for Rocketdevs</h1>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of rocketdevs's Website.
      </p>
      <br />
      <span style={{ textTransform: "capitalize" }}> rocketdevs</span> is
      located at:
      <br />
      <address>
        <br />
      ...
      <p>
        ...
        conditions in full. Do not continue to use rocketdevs's website if you
      ...
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By using rocketdevs's website you consent
        to the use of cookies in accordance with rocketdevs's privacy policy.
      </p>
      <p>
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, rocketdevs and/or it's licensors own the
        intellectual property rights for all material on rocketdevs. All
        intellectual property rights are reserved. You may view and/or print
        pages from https://rocketdevs.com for your own personal use subject to
        restrictions set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ol>
        <li>Republish material from https://rocketdevs.com</li>
        <li>Sell, rent or sub-license material from https://rocketdevs.com</li>
        <li>
          Reproduce, duplicate or copy material from https://rocketdevs.com
        </li>
      </ol>
      <p>
        Redistribute content from rocketdevs (unless content is specifically
      ...
      <p>
        ...
        rocketdevs; and (d) where the link is in the context of general resource
      ...
      <p>
        ...
        <a
          ...
          title="send an email to christopher.fajardo73@gmail.com"
        >
          christopher.fajardo73@gmail.com
        </a>
      ...
      <p>
        No use of rocketdevs's logo or other artwork will be allowed for linking
